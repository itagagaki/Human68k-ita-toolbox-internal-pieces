...
date_tbl:	dc.b	'ì˙åéâŒêÖñÿã‡ìyÅH'
msg_datetime1:	dc.b	'åªç›ÇÃ'
msg_date:	dc.b	'ì˙ït',0
msg_datetime2:	dc.b	'ÇÕ ',0
msg_datetime3:	dc.b	' Ç≈Ç∑',CR,LF,0
msg_datetime4:	dc.b	'Çì¸óÕÇµÇƒÇ≠ÇæÇ≥Ç¢: ',0
