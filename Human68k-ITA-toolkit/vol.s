...
vol_change_2:
		...
		*
		...
		bmi	vol_errm
		*
		*  新しいボリューム・ラベルのタイム・スタンプを
		*  旧ボリューム・ラベル（もしあれば）に合わせる
		*
...
msg_volume1:	dc.b	'ドライブ ',0
msg_volume2:	dc.b	': のボリュ－ムラベルは',0
msg_datetime3:	dc.b	' です',CR,LF,0
msg_novolume:	dc.b	'ありません',CR,LF,0
msg_volume_err:	dc.b	'ボリュ－ムラベルが無効です',CR,LF,0
msg_volnomake:	dc.b	'ボリュ－ムラベルが作れません',CR,LF,0
msg_drive_err:	dc.b	'ドライブ名が無効です',CR,LF,0
msg_bad_arg:	dc.b	'パラメ－タが無効です',CR,LF,0
msg_volnodel:	dc.b	'旧'
msg_volnodel1:	dc.b	'ボリュ－ムラベルが消去できません',CR,LF,0
msg_volnofound:	dc.b	'ボリュ－ムラベルが見つかりません',CR,LF,0
****************************************************************
.bss
